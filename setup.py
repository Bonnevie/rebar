...
setup(
  name = 'relax',
  packages = ['relax'], # this must be the same as the name above
  version = '0.1',
  ...
  download_url = 'https://github.com/Bonnevie/rebar/archive/0.1.tar.gz', # I'll explain this in a second
  keywords = ['estimator', 'gradient', 'tensorflow', 'discrete', 'sampling'], # arbitrary keywords
  classifiers = [],
)
